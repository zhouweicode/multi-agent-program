...
class Settings:
    ...
    milvus_uri: str = ".runtime/milvus.db"
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(model_provider=provider,
                   ...
                   entity_backend=os.getenv("ENTITY_BACKEND", "mock").lower(),
                   ...
                   milvus_uri=os.getenv("GRAPHRAG_MILVUS_URI", ".runtime/milvus.db"),
