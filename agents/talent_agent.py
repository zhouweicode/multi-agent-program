...
from tools.talent_tools import get_person_profile, get_employment_history, get_education_history, match_employment_overlap
...
def build_talent_agent() -> ToolCallingDomainAgent:
    return ToolCallingDomainAgent("talent_agent", ModelFactory.tool_calling_model("talent"),
                                  [get_person_profile, get_employment_history, get_education_history, match_employment_overlap])
